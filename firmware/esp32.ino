# firmware Folder
//This folder contains ESP32 Arduino code files.
...
#include <time.h> //  Added for accurate timestamps
...
// **Backend Server URL**
const char* serverUrl = "give you url";

// **Ultrasonic Sensor Pins**
#define echoPin 13
#define trigPin 12

// **MQ-2 Gas Sensor Pin (Used for Flame Detection)**
